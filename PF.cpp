...
void myData() {
	...
	float verticesPiso[] = {
		// positions          // texture coords
		 10.5f,  10.5f, 0.0f,   8.0f, 8.0f, // top right
		 10.5f, -10.5f, 0.0f,   8.0f, 0.0f, // bottom right
		-10.5f, -10.5f, 0.0f,   0.0f, 0.0f, // bottom left
		-10.5f,  10.5f, 0.0f,   0.0f, 8.0f  // top left 
	};
...
int main() {
	...
	//**********************  DISEÑO PROYECTO  *****************************//
	//Model Plaza("resources/objects/CentroComercial/CentroComercial.obj");
	//Model wc("resources/objects/wc.obj");
	...
	Model Deco1("resources/objects/DecPasillo/DecPasillo.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		//Decoracion Pasillo Principal vista superior
		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -1.9f, 0.0f));
		staticShader.setMat4("model", modelOp);
		Deco1.Draw(staticShader);
